...
from .views import (index_view, register_done_view, activate_user_view, 
                    login_error_view, profile_view, logout_view, oficial_doc_view,
                    RegisterView, ProfileUpdateView, ProfileDeleteView)
...
urlpatterns = [
    ...
    path('documentation/', oficial_doc_view, name='documentation'),
